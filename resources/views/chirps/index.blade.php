<x-app-layout>
    ...
    class="block w-full rounded-md border-gray-300 bg-black shadow-sm transition-colors duration-300 focus:border-indigo-300 dark:focus:ring-indigo-200 dark:focus:ring-opacity-50"
    placeholder="¿Qué estás pensando?">{{ old('message')}}</textarea>
            ...
            <div class="mt-6 bg-white dark:bg-gray-800 shadow-sm rounded-lg divide-y dark:divide-gray-900">
              ...
              <x-dropdown>
                <x-slot name="trigger">
                    <button><svg class="w-5 h-5 text-gray-400 dark:text-gray-200" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
